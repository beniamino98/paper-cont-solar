#' Standard Project ggplot Theme
#'
#' A reusable ggplot2 theme for figures in the paper.
#'
#' @return A `ggplot2` theme object.
#' @export
# Standard theme for figures 
...
#' Extract a ggplot Legend
#'
#' Extract the legend grob from a ggplot object.
#'
#' @param a.gplot A ggplot object.
#'
#' @return A grid grob containing the legend.
#' @references https://github.com/hadley/ggplot2/wiki/Share-a-legend-between-two-ggplot2-graphs
#' @keywords internal
...
#' Build Percentage Axis Breaks and Labels
#'
#' Create symmetric or mean-centered percentage breaks for plotting returns.
#'
#' @param x Numeric vector used to infer plotting range.
#' @param n Numeric scalar. Approximate number of breaks.
#' @param mean_x Optional numeric center value.
#' @param digits Integer. Number of decimal digits in labels.
#'
#' @return List with numeric `breaks` and character `labels`.
#' @keywords internal
